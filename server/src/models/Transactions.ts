...
export interface ITransaction extends Document {
  ...
  type: 'game_reward' | 'mission_reward' | 'achievement_reward' | 'upgrade_purchase' | 'shop_purchase' | 'referral' | 'marketplace_purchase' | 'marketplace_sale' | 'leaderboard_reward';
...
const transactionSchema = new Schema<ITransaction>({
  ...
  type: {
    type: String,
    enum: ['game_reward', 'mission_reward', 'achievement_reward', 'upgrade_purchase', 'shop_purchase', 'referral', 'marketplace_purchase', 'marketplace_sale', 'leaderboard_reward'],
    required: true
  },
