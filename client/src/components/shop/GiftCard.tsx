...
function GiftCard({
  ...
  return (
    <div
      className="relative w-full rounded-2xl overflow-hidden cursor-pointer active:scale-95 transition-transform shadow-xl mt-10"
      style={{ aspectRatio: '16/7' }}
      onClick={isPurchasing ? undefined : onPurchase}
    >
      {isPurchasing && <ButtonSpinner size="large" overlay />}
